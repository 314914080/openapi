 ...
 * @Version: V1.0
 */
@ApiModel(value="fi_im_reuls_config_ddetail对象", description="贷方科目设置")
@Data
@TableName("fi_im_reuls_config_ddetail")
public class FiImReulsConfigDdetail implements Serializable {
