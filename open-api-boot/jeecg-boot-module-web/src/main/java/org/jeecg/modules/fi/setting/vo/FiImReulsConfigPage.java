 ...
 */
@Data
@ApiModel(value="fi_im_reuls_configPage对象", description="凭证导入规则设置")
public class FiImReulsConfigPage {
	...
	@ExcelCollection(name="借方科目设置")
	@ApiModelProperty(value = "借方科目设置")
	private List<FiImReulsConfigJdetail> fiImReulsConfigJdetailList;
	@ExcelCollection(name="贷方科目设置")
	@ApiModelProperty(value = "贷方科目设置")
	private List<FiImReulsConfigDdetail> fiImReulsConfigDdetailList;
